...
public class Module10New extends BaseClass
{

	SendTestReportInEmail email=new SendTestReportInEmail();
	
	public Module10New() throws Exception
	{
		super();
	...
	public Object[][] getDataFromDataprovider() 
	{
		...
		try
		{
			sht = file.readExcel("F:\\JAVA\\Selenium\\PallaviAssignment","Pallavi_Assignment_Validation_Object_Repository.xls", "Module10");
		} catch (Exception e)
		{
			// TODO Auto-generated catch block
			e.printStackTrace();
